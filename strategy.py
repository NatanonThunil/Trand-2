...
def scan_top_th_symbols(limit=5000, callback=None): return scan_generic_market("🇹🇭 TH", "thailand", TOP_CACHE_TH, "BUY", limit, callback)
def scan_top_cn_symbols(limit=5000, callback=None): return scan_generic_market("🇨🇳 CN", "china", TOP_CACHE_CN, "BUY", limit, callback)
def scan_top_hk_symbols(limit=5000, callback=None): return scan_generic_market("🇭🇰 HK", "hongkong", TOP_CACHE_HK, "BUY", limit, callback)
def scan_top_us_stock_symbols(limit=5000, callback=None): return scan_generic_market("🇺🇸 US", "america", TOP_CACHE_US_STOCK, "BUY", limit, callback)
def scan_top_crypto_symbols(limit=1000, callback=None): return _scan_crypto(TOP_CACHE_CRYPTO, "BUY", limit, callback)

def scan_top_th_sell_symbols(limit=5000, callback=None): return scan_generic_market("🇹🇭 TH", "thailand", TOP_SELL_CACHE_TH, "SELL", limit, callback)
def scan_top_cn_sell_symbols(limit=5000, callback=None): return scan_generic_market("🇨🇳 CN", "china", TOP_SELL_CACHE_CN, "SELL", limit, callback)
def scan_top_hk_sell_symbols(limit=5000, callback=None): return scan_generic_market("🇭🇰 HK", "hongkong", TOP_SELL_CACHE_HK, "SELL", limit, callback)
def scan_top_us_stock_sell_symbols(limit=5000, callback=None): return scan_generic_market("🇺🇸 US", "america", TOP_SELL_CACHE_US_STOCK, "SELL", limit, callback)
